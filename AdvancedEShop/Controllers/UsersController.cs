...
namespace AdvancedEShop.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdUser,Name,Phone,Avatar,Email,Password,IsAdmin")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUser,Name,Phone,Avatar,Email,Password,IsAdmin")] User user)
        {
            if (id != user.IdUser)
            {
                return NotFound();
